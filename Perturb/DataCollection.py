...
def GetDataCollectionGroup(rootGroup, verbose=False):
    return LPFU.GetGroup(rootGroup,"DataCollection",verbose)
...
def GetObservationsGroup(rootGroup,verbose=False):
    ...
    if resp["errorFlag"]:
        ...
        return LPFU.GetGroup(resp["value"],"Observations",verbose)
...
def GetContactsGroup(rootGroup,verbose=False):
    ...
    if resp["errorFlag"]:
        ...
        return LPFU.GetGroup(resp["value"],"Contacts",verbose)
...
def GetDrillholesGroup(rootGroup,verbose=False):
    ...
    if resp["errorFlag"]:
        ...
        return LPFU.GetGroup(resp["value"],"Drillholes",verbose)
